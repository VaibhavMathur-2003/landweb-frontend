...
const Home = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
      {/* Sidebar */}
      <div className="w-full md:w-64 bg-gradient-to-b from-blue-700 to-indigo-900 text-white px-4 py-6 max-md:py-2 rounded-sm">
      ...
      <div className="flex-1 p-4 bg-gray-100 overflow-x-auto">
        <div className="max-w-3xl mx-auto">
          <div className="mb-4 max-md:flex-col flex justify-between">
            <input
              type="text"
            ...
            <button
              className="flex max-md:my-3 items-center py-2 px-4 bg-green-500 text-white rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition duration-300 ease-in-out"
